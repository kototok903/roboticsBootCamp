...
public class TeleOp extends LinearOpMode {
    ...
    private void driveset() {
        ...
        frontLeftV  = frontLeftV  / (2.8 * MAX_STICK_COORD) * MAX_POWER; // 2.8 = ls_y (1) + ls_x (1) + 0.8rs_x (0.8)
        frontRightV = frontRightV / (2.8 * MAX_STICK_COORD) * MAX_POWER;
        backLeftV   = backLeftV   / (2.8 * MAX_STICK_COORD) * MAX_POWER;
        backRightV  = backRightV  / (2.8 * MAX_STICK_COORD) * MAX_POWER;
